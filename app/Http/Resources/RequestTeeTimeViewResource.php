...
class RequestTeeTimeViewResource extends JsonResource
{
    /**
    ...
    return [
            ...
            'request_created_at' => $this->date,
            'min_tee_time_name' => ($this->minTeeTime) ? $this->minTeeTime->name : '',
            'max_tee_time_name' => ($this->maxTeeTime) ? $this->maxTeeTime->name : '',
            'date' => ($this->requestProduct->destination->request) ? $this->requestProduct->destination->request->created_at : null,
            ...
            'alternative_count' => ($this->alternatives) ? count($this->alternatives) : 0,

// 'ddd'=>'dd',
            // 'alternatives' => RequestAlternativeTeeTimeViewResource::collection($this->alternatives),
