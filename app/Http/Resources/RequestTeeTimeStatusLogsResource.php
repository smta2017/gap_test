...
class RequestTeeTimeStatusLogsResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        return [
            ...
            'user_role_id' => ($this->userData()) ? $this->userData()->details->role_id  : '',
    ...
    public function is_system_action()
    {
        ...
        if (str_contains($subStatusName, 'Redirected'))
        { 
            return 1;
        }
    ...
    public function get_action_name()
    {
        ...
        if($this->subject_type == 'App\Models\RequestProductTeeTime' && $this->description == 'updated' && $this->get_status_from_properties($this->properties, 'attributes','status_id') == null)
        {
            return 'TeeTime Updated';
        }

        if($this->get_status_from_properties($this->properties, 'attributes','parent_id') == $this->subject_id)
        {
