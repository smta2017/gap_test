...
class TourOperatorDetailsResource extends JsonResource
{
    ...
    */
    ...
    {    
        return [
            ...
            'name' => $this->name,
            'ref_id' => $this->ref_id,
            "has_gfp_requests" => $this->has_gfp_requests,
            ...
            // 'travelagencies' => BaseDataResource::collection($this->travelagencies),
            'travelagencies' => [],
